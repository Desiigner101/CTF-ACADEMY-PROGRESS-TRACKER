  ...
  const sprintData = [
    ...
    },
    {
      ...
      tasks: [
        ...
        { name: 'Test responsive design', points: 1, completed: false },
        { name: 'Backend Development (Part 1/2)', points: 1, completed: false },
        { name: 'Implement new API endpoints for core admin features', points: 1, completed: false },
        { name: 'Optimize database queries', points: 1, completed: false },
        { name: 'Add error handling and logging', points: 1, completed: false },
        { name: 'Write unit tests for new backend services', points: 1, completed: false },
        { name: 'Create API documentation', points: 1, completed: false },
        { name: 'CRUD Operations', points: 2, completed: false },
        { name: 'Home Page Wireframe', points: 1, completed: false },
        { name: 'Landing Page Wireframe', points: 1, completed: false },
        { name: 'Dashboard Wireframe', points: 1, completed: false },
        { name: 'Profile Page Wireframe', points: 1, completed: false },
        { name: 'Admin & Registration Pages Wireframe', points: 1, completed: false },
        { name: 'Challenge List & Challenge Description Wireframe', points: 1, completed: false },
        { name: 'Set Visual Theme and Fonts', points: 1, completed: false },
        { name: 'Design Navigation Elements (Navbar, Sidebar, Footer)', points: 1, completed: false },
        { name: 'Create Component Library (buttons, forms, cards, modals)', points: 1, completed: false },
        { name: 'Apply Consistent Layouts (UI system, spacing, alignment)', points: 1, completed: false },
        { name: 'Interactive States (hover, active, loading spinners, error states)', points: 1, completed: false },
        { name: 'Create Solo Page Design', points: 1, completed: false },
        { name: 'Design Landing Page', points: 1, completed: false },
        { name: 'Design Dashboard Page', points: 1, completed: false },
        { name: 'Design Home Page', points: 1, completed: false },
        { name: 'Design Profile Page', points: 1, completed: false },
        { name: 'Design Online Users & Friends Description', points: 1, completed: false },
        { name: 'Frontend Development (Part 1/2)', points: 1, completed: false },
        { name: 'Implement Challenge List UI & Challenge Description layout', points: 1, completed: false },
        { name: 'Connect frontend components to backend APIs', points: 1, completed: false },
        { name: 'Implement collapsed layout', points: 1, completed: false },
        { name: 'Implement home page layout', points: 1, completed: false },
        { name: 'Implement landing page layout', points: 1, completed: false },
        { name: 'Implement Profile Page layout', points: 1, completed: false }
      ]
    },

    {
      ...
      completedTasks: 0,
      tasks: [
        { name: 'Api Testing Via Postman', points: 1, completed: false },
        { name: 'Add Security Measures (Input Sanitization)', points: 1, completed: false },
        { name: 'Finalization of Backend', points: 3, completed: false },
        { name: 'Apply Global Look & Feel', points: 2, completed: false },
        { name: 'Perform frontend testing', points: 1, completed: false },
        { name: 'Add loading indicators and error messages', points: 1, completed: false },
        { name: 'FInalization of Frontend', points: 3, completed: false },
        { name: '10 - 15 Core Challenges', points: 5, completed: false },
        { name: 'Challenge Descriptions', points: 1, completed: false },
        { name: 'Difficulty Labels', points: 1, completed: false },
        { name: 'Add Scoring System', points: 2, completed: false },
        { name: 'Search Feature For Challenges', points: 1, completed: false },
        { name: 'Leaderboard System', points: 2, completed: false },
        { name: 'Show Completed Challenges', points: 1, completed: false },
        { name: 'Show Incomplete Challenges', points: 1, completed: false },
